...
public class AdapterRecyclerView extends RecyclerView.Adapter<AdapterRecyclerView.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.jzvdStd.setUp(
                ...
                VideoConstant.videoTitles[0][position], Jzvd.SCREEN_NORMAL,true);
        Glide.with(holder.jzvdStd.getContext()).load(VideoConstant.videoThumbs[0][position]).placeholder(R.drawable.place).into(holder.jzvdStd.thumbImageView);
    }
