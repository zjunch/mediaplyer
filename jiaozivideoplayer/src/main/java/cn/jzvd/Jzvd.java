...
public abstract class Jzvd extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    private  boolean isCloseFullScreenCommpent;
    ...
    public void setUp(String url, String title,boolean isCloseFullScreenCommpent) {
        this.isCloseFullScreenCommpent=isCloseFullScreenCommpent;
        setUp(new JZDataSource(url, title), SCREEN_NORMAL);
    }

    public void setUp(String url, String title, int screen,boolean isCloseFullScreenCommpent) {
        this.isCloseFullScreenCommpent=isCloseFullScreenCommpent;
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mChangePosition) {
                        ...
                        Log.e("zjun","mSeekTimePosition:"+mSeekTimePosition+" totalTimeDuration:"+totalTimeDuration);
...
//                        mDownY = y;
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (mChangePosition) {
                        ...
                        Log.e("zjun1","mSeekTimePosition:"+mSeekTimePosition+" totalTimeDuration:"+duration);
    ...
    public void onStateAutoComplete() {
        if(isCloseFullScreenCommpent&&screen==SCREEN_FULLSCREEN){   //全屏播放完直接返回
//            backPress();
//            return;
        }
    ...
    public  void hideSystemUI(){
        if(screen==SCREEN_FULLSCREEN){   //解决有导航栏全屏状态锁屏--再开屏--点击播放--点击切换竖屏。UI不会铺满全屏
            Log.e("zjun","全屏");
    ...
    public void onVideoSizeChanged(int width, int height) {
        ...
        mVideoWidth=width;
        mVideoHeight=height;
        Log.i("zjun","width:"+width+" height:"+height);
        if (textureView != null) {
            if (videoRotation != 0) {
...
//        Log.d(TAG, "onProgress: progress=" + progress + " position=" + position + " duration=" + duration);
    ...
    public void gotoScreenFullscreen() {
        ...
        int screenOration=FULLSCREEN_ORIENTATION;
        if(mVideoHeight>mVideoWidth){
            screenOration=NORMAL_ORIENTATION;
        }
        JZUtils.setRequestedOrientation(getContext(), screenOration);
...
//                Log.v(TAG, "onProgressUpdate " + "[" + this.hashCode() + "] ");
    ...
    public static boolean backPress() {
        ...
        if (CONTAINER_LIST.size() != 0 && CURRENT_JZVD != null) {//判断条件，因为当前所有goBack都是回到普通窗口
            ...
            if(ZVideoManager.videoType== ZVideoManager.FullScreenBackType.CLOSE_VIDEO){
                 releaseAllVideos();   //关闭所有的视频，不然当播放完成直接返回会重新播放
            }
            return true;
